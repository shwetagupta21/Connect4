...
public class Controller<isEnded> implements Initializable {
...

    {
	    ...
	    setNamesButton.setOnAction(new EventHandler<ActionEvent>() {
		    ...
		    public void handle(ActionEvent event) {
			    ...
			    PLAYER_ONE = PLAYER_ONE.valueOf(playerOneTextField.getText());
			    PLAYER_TWO= PLAYER_TWO.valueOf(playerTwoTextField.getText());
	...
	private List<Rectangle> creatClickableColumns()
	{
	     List<Rectangle> rectangleList= new ArrayList<>();
		  ...
		  rectangle.setOnMouseEntered(event-> rectangle.setFill(Color.valueOf("#eeeeee60")));
    ...
    private  void insertDisc(Disc disc,int column) {
       ...
       disc.setTranslateX(column *(CIRCLE_DIAMETER+5)+ CIRCLE_DIAMETER/4);
           ...
           translateTransition.setOnFinished(event ->
           {
           	...
           	playerNameLabel.setText(String.valueOf(isPlayerOneTurn?PLAYER_ONE.valueOf(playerOneTextField.getText()):PLAYER_TWO.valueOf(playerTwoTextField.getText())));
           });
